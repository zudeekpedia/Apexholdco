...
<html lang="en">
  ...
  <head>
    ...
    <!-- Site Title  -->
    <title>Deposit - Apexholdco</title>
...
<div class="px-lg-5 mt-4">
    <div class="post-box p-0 pb-4">
      <div class="d-flex border-bottom p-3">
        <p class="m-0 roboto xsmall-sm bold-text">Deposit</p>
    
      </div>
    
      <form action="https://www.apexholdco.com/user/data/process-deposit.php" method="POST" id="depositForm">
            ...
            <div class="mt-3 timeline-wrapper p-3">
              ...
              <div class="timeline-body">
                <div class="p-3 dark-input add-radius d-flex" style="cursor: pointer;" data-toggle="modal" data-target="#selectTokenToFund">
                  ...
                  <p class="ft-n m-0 ml-3 top-2 flex-fill xsmall grey-color" id="tokenName">Crypto</p>
    
                  <!-- -- -->
                  <input type="hidden" name="currency_id" id="tokenId" value=""  required>
                  <!-- -- -->
            ...
            <div class="border-top pt-4 p-3">
              <div class="d-flex">
                ...
                <div class="ml-3 flex-fill">
                  <small class="xsmall2 greyWhite mb-2">Available Asset</small>
                  <p class="roboto xsmall2 m-0 boldText grey-color-2">Current balance (Est.)</p>
                </div>
                    ...
                    <div class="mt-4">
                        ...
                        <div style="height: 350px; overflow: auto;" class="style-scrollbar px-2">
                            ...
                            <div class="d-flex tokens pointer cs-list-item p-3" onclick="setFundToken('<?= htmlspecialchars($token['name']); ?>', '<?= htmlspecialchars($token['symbol']); ?>', '<?= htmlspecialchars($token['token_id']); ?>', <?= htmlspecialchars($token_bal); ?>)">
                                <img src="<?= 'https://www.apexholdco.com/admin-control/admin/data/' . htmlspecialchars($token['logo']); ?>" alt="<?= htmlspecialchars($token['symbol']); ?>" style="width: 20px; height: 20px;" onerror="this.src='https://www.apexholdco.com/assets/images/token.png'" class="top-2 rounded-circle">
