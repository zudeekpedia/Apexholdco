...
<html lang="en">
  ...
  <head>
    ...
    <!-- Site Title  -->
    <title>Wallet Asset Balances - Apexhold</title>
  ...
  <div class="col-12 col-lg-6 px-0">
    <div class="post-box p-4">
      <div class="row">
        <div class="col-10">
          <small class="xsmall grey-color-2">Total Plans Available</small><br>
          <h5 class="bold-text">
            <?= $totalplans;?> <small class="xsmall grey-color">Plan(s)</small>
          </h5>
        </div>
        <div class="col-2 text-right">
          <a href="https://www.apexholdco.com/user/transactions">
            <i class="material-icons grey-color-2 p-2 dark-bg2 top-3"
              style="font-size: 18px !important; border-radius: 4px;">receipt_long</i>
          </a>
        </div>
      </div>
      ...
      <div class="row mt-4 px-1">
        <div class="col-4 px-1">
          <a href="https://www.apexholdco.com/user/deposit">
            <button class="xsmall2 py-2 meri-weda"> Deposit</button>
          </a>
        </div>
        <div class="col-4 px-1">
          <a href="#" data-target="#withdrawal-modal" data-toggle="modal">
            <button class="xsmall2 py-2 meri-weda btn-grey">Withdraw</button>
          </a>
        </div>
        <div class="col-4 px-1">
          <a href="https://www.apexholdco.com/user/invest">
            <button class="xsmall2 py-2 meri-weda btn-grey">Invest</button>
          </a>
        </div>
      </div>
    </div>
  ...
  <div class="col-12 px-0">
    <div class="post-box mt-2 p-4">
      <p class="meri-weda">Active Investment Balances</p>
           <?php
            $plans = getAllPlans();
            $i = 1;
            ...
            if (!empty($plans)) :
                foreach ($plans as $plan) :
                    ...
                    $plan_bal = getPlanInvestment($plan['id'],$plan['name'],$uID);
                    $plan_bal = number_format((float)$plan_bal, 2, '.', '');
            ?>
              <div class="d-flex">
                <p class="m-0 flex-fill">
                  <?= $plan['name'];?> <small class="d-block xsmall2 grey-color"><?= $plan['name'];?> (<?= $plan['id'];?>)</small>
                </p>
                <p class="roboto bold-text xsmall">
                  $<?= $plan_bal;?>
                </p>
              </div> 
        <?php
