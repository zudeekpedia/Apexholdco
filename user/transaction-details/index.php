...
$transactionsid = $transactions['transaction_id'];

//get coins details
$coin = getCoinNameById($transactions['token_id']);
$coin = $coin[0];
?>
       <div class="mt-3 table-responsive col-md-10">

            <div class="card-title">
              <h4>Transaction ID #<?= $transactions['transaction_id']?></h4>
            </div>
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-striped table-hover">
                <tbody>
                  <tr>
                    <td class="grey-color-2"><b>Transaction ID</b></td>
                    <td class="white-text"><?= $transactions['transaction_id']?></td>
                  </tr>
                  <tr>
                    <td class="grey-color-2"><b>Currency</b></td>
                    <td class="white-text"><?= $coin['name']?></td>
                  </tr>
                  <tr>
                    <td class="grey-color-2"><b>Amount</b></td>
                    <td class="white-text"><?= $transactions['amount']?></td>
                  </tr>
                  <tr>
                    <td class="grey-color-2"><b>Type</b></td>
                    <td class="white-text"><?= $transactions['direction']?></td>
                  </tr>
                  <tr>
                    <td class="grey-color-2"><b>Status</b></td>
                    <?php
                    if($transactions['status'] === 'pending'){
                        ...
                        echo '<td>
                                        <span class="badge badge-success" title="You have made payment and upload payment proof">Success</span>
                                        </td>';
                    }
                    ?>
    ...
    <div class="my-2 mb-4">
        <div class="row mt-5">
            <div class="col-6">
                <a href="https://www.apexholdco.com/user/payment/<?= htmlspecialchars($transactionsid); ?>">
                    <button class="btn btn-grey grey-color-2 xsmall">
                        Make Payment
                    </button>
                </a>
            </div>
            <div class="col-6">
                <a href="https://www.apexholdco.com/user/upload-proof/<?= htmlspecialchars($transactionsid); ?>">
                    <button class="btn btn-outline-primary xsmall bold-text">
                        Confirm Payment
                    </button>
                </a>
            </div>
...
<?php elseif ($transactions['status'] === 'completed'): ?>
    <p class="text-success bold-text">Payment Completed</p>
<?php endif; ?>
